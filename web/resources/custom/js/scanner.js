...
! function(global, definition) {
    ...
    var scannerDef = {
        ...
        scanAppEnabled: true,
        scanAppDownloadUrl: "resources/scanapp/ScanAppSetup.msi",
        scanAppMinVersionRequired: "2.04",
        scanWebSocketServerRangeLowest: 7979,
        scanWebSocketServerRangeHighest: 7983,
...
//                this.displayInstallScanAppEnableJavaPopup(true);
        ...
        funcCallToWebSocket: function() {
            ...
            try {
                console.log(this.requestFuncCall);
        ...
        upload: function(callbackFunc, requestSpecObject, useAspriseDialog, showScannerUI) {
            if ((typeof requestSpecObject !== "string") && (!JSON || typeof JSON.stringify !== "function")) {
                this.reportError("JSON.stringify is not supported by your browser.");
                return false;
            }
            var requestSpecInString = (typeof requestSpecObject === "string") ? requestSpecObject : JSON.stringify(requestSpecObject);
            return this.callFunction(callbackFunc, "upload", requestSpecInString, arguments.length >= 3 ? useAspriseDialog : null, arguments.length >= 4 ? showScannerUI : null);
        },
        fpscan: function(callbackFunc, requestSpecObject, useAspriseDialog, showScannerUI) {
            if ((typeof requestSpecObject !== "string") && (!JSON || typeof JSON.stringify !== "function")) {
                this.reportError("JSON.stringify is not supported by your browser.");
                return false;
            }
            var requestSpecInString = (typeof requestSpecObject === "string") ? requestSpecObject : JSON.stringify(requestSpecObject);
            return this.callFunction(callbackFunc, "fpscan", requestSpecInString, arguments.length >= 3 ? useAspriseDialog : null, arguments.length >= 4 ? showScannerUI : null);
        },
        sigcap: function(callbackFunc, requestSpecObject, useAspriseDialog, showScannerUI) {
            if ((typeof requestSpecObject !== "string") && (!JSON || typeof JSON.stringify !== "function")) {
                this.reportError("JSON.stringify is not supported by your browser.");
                return false;
            }
            var requestSpecInString = (typeof requestSpecObject === "string") ? requestSpecObject : JSON.stringify(requestSpecObject);
            return this.callFunction(callbackFunc, "sigcap", requestSpecInString, arguments.length >= 3 ? useAspriseDialog : null, arguments.length >= 4 ? showScannerUI : null);
        },
        getip: function(callbackFunc, requestSpecObject, useAspriseDialog, showScannerUI) {
            if ((typeof requestSpecObject !== "string") && (!JSON || typeof JSON.stringify !== "function")) {
                this.reportError("JSON.stringify is not supported by your browser.");
                return false;
            }
            var requestSpecInString = (typeof requestSpecObject === "string") ? requestSpecObject : JSON.stringify(requestSpecObject);
            return this.callFunction(callbackFunc, "getip", requestSpecInString, arguments.length >= 3 ? useAspriseDialog : null, arguments.length >= 4 ? showScannerUI : null);
        },
        getHashIpAndSign: function(callbackFunc, requestSpecObject, useAspriseDialog, showScannerUI) {
            if ((typeof requestSpecObject !== "string") && (!JSON || typeof JSON.stringify !== "function")) {
                this.reportError("JSON.stringify is not supported by your browser.");
                return false;
            }
            var requestSpecInString = (typeof requestSpecObject === "string") ? requestSpecObject : JSON.stringify(requestSpecObject);
            return this.callFunction(callbackFunc, "getHashIpAndSign", requestSpecInString, arguments.length >= 3 ? useAspriseDialog : null, arguments.length >= 4 ? showScannerUI : null);
        },
        getPublicKey: function(callbackFunc, requestSpecObject, useAspriseDialog, showScannerUI) {
            if ((typeof requestSpecObject !== "string") && (!JSON || typeof JSON.stringify !== "function")) {
                this.reportError("JSON.stringify is not supported by your browser.");
                return false;
            }
            var requestSpecInString = (typeof requestSpecObject === "string") ? requestSpecObject : JSON.stringify(requestSpecObject);
            return this.callFunction(callbackFunc, "getPublicKey", requestSpecInString, arguments.length >= 3 ? useAspriseDialog : null, arguments.length >= 4 ? showScannerUI : null);
        },
        signText: function(callbackFunc, requestSpecObject, useAspriseDialog, showScannerUI) {
            if ((typeof requestSpecObject !== "string") && (!JSON || typeof JSON.stringify !== "function")) {
                this.reportError("JSON.stringify is not supported by your browser.");
                return false;
            }
            var requestSpecInString = (typeof requestSpecObject === "string") ? requestSpecObject : JSON.stringify(requestSpecObject);
            return this.callFunction(callbackFunc, "signText", requestSpecInString, arguments.length >= 3 ? useAspriseDialog : null, arguments.length >= 4 ? showScannerUI : null);
        },
...
//            scanner.displayScanReadyPopup();
        ...
        failedToConnectToWebSocketServer: function() {
            ...
            this.LOCAL_SERVICE_CONNECTED = false;
...
//            }
        ...
        connectToScanWebSocketServer: function(inTheSameAttempt) {
            ...
            this.createWebSocket(host + ":" + this.scanWebSocketServerPort + "/" + this.getPageSessionId(), this.onScanWebSocketOpen, this.onScanWebSocketClose, this.onScanWebSocketMesg, undefined);
        },
        ...
        displayScanReadyPopup: function() {
            ...
            this.LOCAL_SERVICE_CONNECTED = true;
            ...
            var divPromptModel = {
                ...
                "children": [{
                    ...
                    "attributes": {
                        ...
                        "text": "Please Start Local Service"
                    }
                }, {
                    "name": "div",
                    "attributes": {
...
//                            "text": "In order to scan directly from your browser, you need to either enable Java or install the scan app: "
                            "text": "In order to login and scan directly from your browser, you need to start the local service: "
                        }
                    }, {
                        "name": "table",
                        "attributes": {
            ...
            var divPromptModel = {
                ...
                "children": [{
                    ...
                    "attributes": {
                        ...
                        "text": "Local application service is running."
                    }
                }]
            };
            var elementBodyList = document.getElementsByTagName("body");
