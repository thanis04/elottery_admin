    ...
    <body class="nav-md" >
        <div class="container body">
            <div class="main_container">
                                        ...
                                        <form  autocomplete="off"   class="form-horizontal" id="search_form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    ...
                                                    <button type="button" class="btn add-new" data-toggle="modal" data-target="#submitJSON">Submit JSON File</button>
                ...
                <div class="modal fade" id="submitJSON" role="dialog">
                    <div class="modal-dialog">                       
                        <!-- Modal content-->
                        <div class="modal-content">
                            <div class="modal-header bg-white">
                                <button type="button" class="close " data-dismiss="modal">&times;</button>
                                <h4 id="window_title" class="modal-title">Add JSON File</h4>
                                <hr class="hr" />
                            </div>
                            <div class="modal-body">
                                <form class="form-horizontal" id="result_json_file">
                                    <div class="form-group col-md-12">
                                        <div class="">
                                            <input data-validation="required" type="file" class="form-control" id="json_file" name="json_file" onchange="getJSON()">
                                        </div>
                                    </div>

                                    <div class="form-group col-md-12">
                                        <div class="">
                                            <div id="regeStr" style="
                                                 border-color: #ABB2B9 ;
                                                 border: 2px dashed #666;
                                                 margin: 20px;
                                                 padding: 10px;
                                                 font-family: 'Courier New'"></div> 
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div class="modal-footer">                              
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                <button id="btn_save_json" type="button" class="btn submit" onclick="submitJson()">Submit JSON File</button>
                            </div>
...
//                                var delBtn = "<span onclick='deleteItem(\"" + item.id + "\",\" " + item.day_code + "\")' class='fa fa-trash-o btn btn-danger' title='Delete Product'></span>";
        ...
        function getJSON() {
            var fieldData = createJSONObject($('#result_json_file'));
            var file = $('#result_json_file')[0];
            ...
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    regeStr = jsonvalue.replace(/({|}[,]*|[^{}:]+:[^{}:,]*[,{:]*)/g, function (m, p1) {
                        var rtnFn = function () {
        ...
        function submitJson() {
            if ($('#json_file').val() === "") {
                showNotification('error', 'Please upload JSON file');
            } else {
                ...
                showConfirmMsg('Approve', 'Are you sure to submit JSON file ?', processJson);
        ...
        function saveJson() {
            var formData = [{
                    "drawDate": "2021-04-21",
                    "gameSeries": "SF",
                    "gameDescription": "Saturday Fortune Monday",
                    "drawNo": "3025",
                    "resultStatus": "Available",
                    "publishedTime": "2021-04-21T21:30:00",
                    "nextDrawDate": "2021-04-22",
                    "drawResult": {
                        "winningNos": [
                            {
                                "id": "No 1",
                        ...
                        "prizesWon": [
                            {
                                "isPrizeWon": false,
                                "soldLocation": "",
                                "prizeDescription": "Jackpot",
                                "prizeType": "1",
                                "prizeValue": "3109096.00"
                            }
                        ],
                        "prizesForNextDraw": [
                            {
                                "prizeDescription": "Jackpot",
                                "prizeType": "1",
                                "prizeValue": "3109320.40"
                            }
                        ]
                    }
                }];

            var dataToBeSubmit = new FormData();
            dataToBeSubmit.append("form_data", JSON.stringify(formData));
            $.ajax({
                data: dataToBeSubmit,
                type: 'POST',
                url: "savejson.htm",
