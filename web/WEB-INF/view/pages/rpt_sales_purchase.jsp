...
<html>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left" >
                                <h4>Ticket Purchasing / Sales Summary Report</h4>
                            </div>
                        </div>
    ...
    <script>
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            if (response.status === true) {
                                ...
                                $(tabledata).each(function (index) {
                                    ...
                                    var row = [item.lottery_name, item.purchase_count, item.sale_count, parseInt(item.purchase_count) - parseInt(item.sale_count)];
        ...
        function print() {
            if (validateForm($('#search_form'))) {
                $('#search_form').attr('action', '../purchase_report/print_summery_report_bydate.htm')
                $('#search_form').submit();
            }
