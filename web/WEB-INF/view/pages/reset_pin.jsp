<%-- 
    Document   : reset_pin
    Created on : Aug 3, 2021, 2:49:36 PM
    Author     : nipuna_k
--%>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        </label><span class="text-secondary" style="font-size: 12px"> (Please specify who requested the PIN change)</span> 
                                        <div class="">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button id="btn_update" type="button" class="btn btn-primary" onclick="updateItem()"> Submit </button>
    ...
    <script>
                        ...
                        if (response.status === "success") {
                            ...
                            $(tabledata).each(function (index) {
                                ...
                                if (item.isRequested) {
                                    ...
                                    requestBtn = "<span onclick='editItem(\"" + item.id + "\")' class='fa fa-pencil btn btn-success' title='Reset PIN'></span>";
                                }

                                var row = [item.first_name + " " + item.last_name, item.username, item.nic, item.mobile_no, item.last_login, requestBtn];
        ...
        function updateItem() {
            ...
            if ($('#new_form #remark').val() === "") {
                showNotification('error', "Please specify who requested the change");
            } else if (length > 250) {
