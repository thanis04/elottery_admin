<%-- 
    Document   : rpt_ticket_inventory
    Created on : Feb 27, 2020, 2:55:31 PM
    Author     : nipuna_k
--%>
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            if (response.status === true) {
                                ...
                                $(tabledata).each(function (index) {
                                    ...
                                    var row = [item.lottery_name, item.draw_no, item.draw_date, item.tkt_reff, item.tkt_value, item.currency, item.ticket_pur_date];
