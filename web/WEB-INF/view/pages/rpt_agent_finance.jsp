<%-- 
    Document   : rpt_agent_finance
    Created on : Jul 28, 2021, 10:01:42 PM
    Author     : nipuna_k
--%>
...
//            alert(page);
                ...
                resultTable = $('#result_table').DataTable
                        ({
                            ...
                            "columns":
                                    [
                                        {"title": "Sub-Agent Code", "data": "agent_code", "defaultContent": "-"},
                                        {"title": "Sub-Agent name", "data": "agent_name", "defaultContent": "-"},
                                        {"title": "Customer Name", "data": "cus_name", "defaultContent": "-"},
                                        {"title": "Customer NIC", "data": "nic", "defaultContent": "-"},
                                        {"title": "Ticket purchased", "data": "ticket_count", "defaultContent": "-"},
                                        {"title": "Last Login Time", "data": "last_login_time", "defaultContent": "-"}
                                    ]
                        });
            }
        }
