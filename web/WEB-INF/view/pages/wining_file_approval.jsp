...
<html>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header bg-primary">
                                ...
                                <h4   class="modal-title">Winning File Approval</h4>
                            </div>
                            <div class="modal-body">
                                <!-- model body -->
                                <h4>Winning File Details</h4>
                                ...
                                <div class="row">     
                                    <div class="col-md-9">    
                                        ...
                                        <div class="form-group">
                                            <p class="text-secondary col-sm-5">Wining Amount</p>
                                            <div class="col-sm-7">                                          
                                                <label class="control-label "  id="view_win_amount" ></label>
                                            </div>
                                        </div>
                                        <br>
                ...
                <div class="modal fade" id="reportModal" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header bg-primary">
                                <button type="button" class="close" onclick="refreshPage();"  data-dismiss="modal">&times;</button>
                                <h4  class="modal-title">Winning  File Approval Report</h4>
                            </div>
                            <div class="modal-body">
                                <!-- model body -->     
                                <div class="row">  
                            ...
                            <div class="modal-footer">     
                                <button onclick="refreshPage()" type="button" class="btn btn-success" onclick="refreshPage();" data-dismiss="modal"><i class="fa fa-check"></i> Ok</button>
                            </div>
                        </div>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    if (response.status === 'success') {
                        ...
                        $('#view_win_amount').html(record.winning_amount);
        ...
        function approve() {
            ...
            showConfirmMsg('Approve', 'Are you sure to approve winning  file ?', fnApprove);
            ...
            function fnShowProcessProgress() {
                ...
                $.ajax({
                    ...
                    success: function (data, textStatus, jqXHR) {
                        ...
                        //hide window if record is ok
                        if (response.status === 'INT' || response.status === 'PND') {
            ...
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    if (response.status === 'success') {
                        ...
                        var record = response.record;
                        $('#view_total_count').html(record.records);
                        $('#view_success_count').html(parseInt(record.records) - parseInt(response.error_count));
