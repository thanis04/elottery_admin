<%-- 
    Document   : rpt_agt_salesbyuser
    Created on : Feb 24, 2021, 10:50:39 AM
    Author     : nipuna_k
--%>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left" >
                                <h4>Sales By Customers Report</h4>
                            </div>
                        </div>
                    ...
                    $.ajax({
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            if (response.status === "success") {
                                $('#search_result').show();
                                resultTable.fnClearTable();
                                var totalVal = "Total number of tickets purchased : " + response.total;
                                ...
                                $(tabledata).each(function (index) {
                                    ...
                                    var row = [item.nameOfUser, item.noOfTickets];
