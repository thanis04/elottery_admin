<%-- 
    Document   : rpt_process_tickets_det
    Created on : Sep 28, 2021, 9:40:44 AM
    Author     : nipuna_k
--%>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left" >
                                <h4>Process Ticket Details Report</h4>
                            </div>
                        </div>
...
//            alert(page);
                ...
                resultTable = $('#result_table').DataTable
                        ({
                            ...
                            "columns":
                                    [
                                        {"title": "Redeem Ticket ID", "data": "red_ticket_id", "defaultContent": "-"},
                                        {"title": "Transaction ID", "data": "txn_id", "defaultContent": "-"},
                                        {"title": "Redemption mode", "data": "red_mode", "defaultContent": "-"},
                                        {"title": "Transaction type", "data": "txn_type", "defaultContent": "-"},
                                        {"title": "Created date", "data": "created_date", "defaultContent": "-"},
                                        {"title": "NIC", "data": "nic", "defaultContent": "-"},
                                        {"title": "Winning prize", "data": "winning_prize", "defaultContent": "-"},
                                        {"title": "RRN", "data": "rrn", "defaultContent": "-"},
                                        {"title": "Response Code", "data": "response_code", "defaultContent": "-"},
                                        {"title": "Redeem Status", "data": "red_status", "defaultContent": "-"},
                                        {"title": "Redeem Date", "data": "red_date", "defaultContent": "-"}
                                    ]
                        });
            }
        }
