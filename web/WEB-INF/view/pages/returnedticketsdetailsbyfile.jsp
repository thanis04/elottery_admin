                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left" >
                                <h4>Returned Ticket Details by File</h4>
                            </div>
                        </div>
                    ...
                    $.ajax({
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            if (response.status === true) 
                            {
                                ...
                                //var buttonTag = "<button type=\"button\" class=\"btn btn-info btn-sm \" type=\"button\"  onclick=\"view(" + "blank param" + ","  + "blank param" + ");\" >View Transaction</button>" ;
...
*/
        ...
        function loadTable() 
        {
                ...
                ({
                    "ajax": 
                    {
                        url: "viewReturndetailspaginated.htm",
                        data: {
                            "fileid":fileid 
                        },
                        type: "POST",
