<%-- 
    Document   : user_review_req_approve
    Created on : Aug 18, 2021, 1:29:26 PM
    Author     : nipuna_k
--%>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h4>Account Deletion Approve</h4>
                            </div>
                        ...
                        <form class="form-horizontal" id="new_form" >
                            ...
                            <div class="modal-content">
                                <div class="modal-header bg-white">
                                    ...
                                    <h4 id="window_title" class="modal-title">Approve Deletion</h4>
                                    <hr class="hr" />
                                </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group col-lg-12">
                                        <label >Remark</label>
                                        <div class="">
                                            <input maxlength="10" data-validation="required-tel" class="form-control" type="text" name="remark" id="remark" />
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button id="btn_update" type="button" class="btn btn-primary" onclick="checkIsItCanDelete()"> Approve </button>
...
//                            } else {
                            requestBtn = "<span onclick='editItem(\"" + item.req_id + "\")' class='fa fa-trash btn btn-success' title='Approve Deletion'></span>";
//                            }

                            var row = [item.fullName, item.username, item.nic, item.mobileNo, item.createdDate, item.requestCreatedDate, item.requestedBy, item.remark, requestBtn];
        ...
        function updateItem() {
            ...
            showConfirmMsg('Approve', 'Are you sure you want to delete this account?', fnApprove);
            ...
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    if (response.status === 'success') {
                        ...
                        $('#new_form #remark').val(record.remark);
                        $('#new_form #remark').attr('disabled', true);
                        $('#new_form #id').val(id);
                        $('#new_form #id').hide();
