<%@page import="com.epic.dlb.util.common.SystemVarList"%> <%@page
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main" style="min-height: 600px">
          <div class="">
            ...
            <div class="row">
              <div
                class="col-md-6 col-sm-12 col-xs-12 col-lg-6 col-md-offset-3 col-lg-offset-3"
                style="float: none"
              >
                <div class="x_panel">
                  <div class="x_title">
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header bg-white">
                ...
                <h4 id="window_title" class="modal-title">
              ...
              <div class="modal-body">
                ...
                <div class="row">
                          ...
                          <div class="form-group">
                            <div class="selectContainer">
                              <select
                                data-validation="required"
                                class="form-control"
                                name="dlbStatus.statusCode"
                                id="statusCode"
                              >
                                <option selected value="0">--Select--</option>
                                <option value="<%=SystemVarList.ACTIVE%>">
                                  Active
                                </option>
                                <option value="<%=SystemVarList.INACTIVE%>">
                                  Inactive
                                </option>
                              </select>
                            </div>
                  ...
                  <div class="col-md-4">
                    <div
                      id="view_update_icon"
                      style="border: gainsboro solid thin; padding: 2px"
                    ></div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <label
                        >Verification Digits<span class="text-red">
                          *</span
                        ></label
                      >
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <input
                        type="number"
                        class="form-control"
                        id="verificationDigits"
                        name="verificationDigits"
                        maxlength="100"
                      />
                    </div>
                    <div class="col-md-3">
                ...
                <div class="form-group col-lg-6">
                  <span class="pull-left text-secondary">
                    Mandatory fields are marked with [<span class="text-red"
                      >*</span
                    >]
                  </span>
                </div>
            ...
            <div class="modal-content">
              <div class="modal-header bg-primary">
                ...
                <h4 class="modal-title">
                  Lottery: <span id="view_title"></span>
                </h4>
              </div>
              <div class="modal-body">
                <!-- model body -->
  ...
  <script>
          ...
          if (response.status === true) {
            ...
            $(tabledata).each(function (index) {
              ...
              var viewBtn =
                ...
                item.id +
                "\")' class='fa fa-eye btn btn-primary' title='View Lottery'></span>";
              var delBtn =
                "<span onclick='deleteItem(\"" +
                item.id +
                "\")' class='fa fa-trash-o btn btn-danger' title='Delete Lottery'></span>";
    ...
    function addItemToTable() {
      ...
      if (
        ...
        var delBtn =
          "<span onclick='deleteGameItem(\"" +
          gameName +
          "\")' class='fa fa-trash-o btn btn-danger' title='Remove Item'></span>";
