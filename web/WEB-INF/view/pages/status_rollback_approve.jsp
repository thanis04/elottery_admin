<%-- 
    Document   : status_rollback_approve
    Created on : Apr 8, 2021, 1:32:25 PM
    Author     : nipuna_k
--%>
...
<html>
                                    ...
                                    <tbody>
                                        <c:forEach var="row" items="${list}">
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <span onclick="approve('${row.id}', '${row.purchaseHistoryId}')" class="fa fa-check btn btn-primary" title='View' ></span>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
    ...
    <script>
        ...
        function approve(id, purchaseHistoryId) {
            showConfirmMsg('Confirmation', 'Are you sure, approve this rollback request ?', ok);
            function ok() {
                var formData = {
                    "id": id,
