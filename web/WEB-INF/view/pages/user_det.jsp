<%-- 
    Document   : user_det
    Created on : Jun 22, 2021, 12:33:18 PM
    Author     : nipuna_k
--%>
    ...
    <script>
        ...
        function searchDevice() {
            ...
            if (validateSearch()) {
                    ...
                    success: function (data, textStatus, jqXHR) {
                        ...
                        if (response.status === true) {
                            ...
                            $(tabledata).each(function (index) {
                                ...
                                var row = [item.user_name, item.fanme + " " + item.lanme, item.nic, item.mobile, item.email, 
                                    item.brand + " - " + item.model, item.login_date];
                ...
                showNotification('error', "Please fill one feild!");
            }
