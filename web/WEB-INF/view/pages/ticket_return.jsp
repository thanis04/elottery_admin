                                    ...
                                    <tbody>
                                        <c:forEach var="row" items="${pending_list}">
                                            <tr>
                                                ...
                                                <td><button onclick="viewRecord('${row.id}')" class="btn btn-success"><i class="fa fa-check"></i> Approve</button></td>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header bg-primary">
                                ...
                                <h4  class="modal-title">Ticket File Approval</h4>
                            </div>
