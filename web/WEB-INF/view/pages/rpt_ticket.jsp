                                    ...
                                    <div class="x_content">
                                        <form autocomplete="off" method="post" target="_blank" action="show_report_bydateAndCategory.htm"  class="form-horizontal" id="search_form" role="form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <select  type="text" class="form-control" name="category" id="category" data-validation="required">
...
<!--                                                <button type="button" class="btn print" onclick="printSummery();">Print Summary Report</button>-->
    ...
    <script>
        ...
        function search() {
            ...
            if (validateForm($('#search_form'))) {
                ...
                if (checkFromDateNToDate(fromDate, toDate) && category !== null) {
                    $.ajax({ 
                        data: formData,
                        url: "show_report_bydateAndCategory.htm",
                        type: 'GET',
        ...
        function print() {
            if (validateForm($('#search_form'))) {
                $('#search_form').attr('action', 'print_report_bydateAndCategory.htm');
                $('#search_form').submit();
            }
