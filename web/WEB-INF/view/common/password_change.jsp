<%-- 
    ...
    Created on : Feb 19, 2021, 11:54:24 AM
    Author     : nipuna_k
--%>
                                    ...
                                    <div class="x_content">
                                        <form  autocomplete="off"   class="form-horizontal" id="password_change_form">
                                            <div class="form-group">
                                                <label class="">Current Password<span class="text-red">*</span></label>
                                                <div class="">
                                                    <input data-validation="required-sp-allow" class="form-control"  type="password" name="old_password" id="old_password" placeholder="Enter Current Password" maxlength="100"/>
                                                </div>
                                            </div>
        ...
        function saveItem() {
            ...
            if ($('#new_password').val() === "" || $('#old_password').val() === ""
                ...
                if ($('#new_password').val() === $('#confirm_password').val()) {
                    ...
                    showNotification("error", "New Password and Confirm Password is not matching");
                }
//            }
            }
        }
