...
import com.epic.dlb.report.builder.DailyTransactionSummaryBuilder;
 ...
 */
@Controller
@RequestMapping("daily_transaction_summary_report")
public class DailyTransactionSummaryController {

    @Autowired
    private UserService userService;

    @Autowired
    private DailyTransactionSummaryBuilder dailyTransactionSummaryBuilder;
    ...
    public String showPage(HttpSession session, Model model) {
        ...
        List checkAuthorization = userService.checkAuthorization(session, "/daily_transaction_summary_report/show_page.htm");
...
//                model.addAttribute("product_select_box", productSelectBox);
                ...
                java.util.logging.Logger.getLogger(DailyTransactionSummaryController.class.getName()).log(Level.SEVERE, null, ex);
            }
            return "pages/rpt_daily_transaction_summary";
        } else {
            //Authorization fail
    ...
    public String showReportData(HttpSession session,
        ...
        if (authStatus) {
            try {
                ...
                reportResult = dailyTransactionSummaryBuilder.dailyTransactionSummaryReportData(fromDate,toDate);
    ...
    public void search(HttpSession session,
        ...
        File generateExcel = dailyTransactionSummaryBuilder.generateExcel(fromDate, toDate);
