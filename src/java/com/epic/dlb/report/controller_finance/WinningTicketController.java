...
import com.epic.dlb.report.builder.WinningTicketBuilder;
 ...
 */
@Controller
@RequestMapping("winning_ticket_report")
public class WinningTicketController {
    ...
    @Autowired
    private WinningTicketBuilder winningTicketBuilder;
    ...
    public String showPage(HttpSession session, Model model) {
        ...
        List checkAuthorization = userService.checkAuthorization(session, "/winning_ticket_report/show_page.htm");
        ...
        if (authStatus) {
            try {
                ...
                java.util.logging.Logger.getLogger(WinningTicketController.class.getName()).log(Level.SEVERE, null, ex);
            }
            return "pages/rpt_winning_ticket";
        } else {
            //Authorization fail
    ...
    public String showReportData(HttpSession session,
            ...
            @RequestParam("lottery") String lottery) throws ParseException {
        ...
        if (authStatus) {
            try {
                ...
                reportResult = winningTicketBuilder.winningTicketReportData(fromDate,toDate, lottery);
    ...
    public void search(HttpSession session,
        ...
        File generateExcel = winningTicketBuilder.generateExcel(fromDate, toDate,lottery);
