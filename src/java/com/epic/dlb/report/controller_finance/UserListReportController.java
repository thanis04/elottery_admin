...
import com.epic.dlb.report.builder.UserListReportBuilder;
...
public class UserListReportController {
    
    @Autowired
    private UserListReportBuilder userListReportBuilder;
    ...
    public String showPage(HttpSession session, Model model) {
        ...
        List checkAuthorization = userService.checkAuthorization(session, "/user_report/show_page.htm");
...
//                model.addAttribute("product_select_box", productSelectBox);
                ...
                java.util.logging.Logger.getLogger(UserListReportController.class.getName()).log(Level.SEVERE, null, ex);
            }
            return "pages/rpt_user_list";
        } else {
            //Authorization fail
    ...
    @ResponseBody
    @RequestMapping(value = "/show_user_report.htm", method = RequestMethod.GET)
    public String showReportData(HttpSession session,
        ...
        if (authStatus) {
            try {
                ...
                reportResult = userListReportBuilder.userReportData(fromDate,toDate);
    ...
    public void search(HttpSession session,
        ...
        File generateExcel = userListReportBuilder.generateExcel(fromDate, toDate);
