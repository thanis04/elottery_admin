 ...
 */
@Controller
@RequestMapping("sales_report_agent")
public class SalesReportAgentController {
    ...
    public String showPage(HttpSession session, Model model) {
        List checkAuthorization = userService.checkAuthorization(session, "/sales_report_agent/show_page.htm");
        ...
        if (agentService.isValid(agentSearchCriteriaDto.getAgentCode(),
            ...
            if (authStatus) {
                try {
                    ...
                    response.put("result", salesReportAgentBuilder.salesReportData(
                            agentService.getSales(agentSearchCriteriaDto)));
                    response.put("total", agentService.getSalesTotal(agentSearchCriteriaDto));
    ...
    public void downloadExcel(HttpSession session, HttpServletResponse resp,
        ...
        if (agentService.isValid(agentCode, systemUser.getDlbWbUserRole().
            ...
            File generateExcel = salesReportAgentBuilder.generateExcel(
                    agentService.getSales(agentSearchCriteriaDto),
