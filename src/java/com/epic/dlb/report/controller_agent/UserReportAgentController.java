...
import com.epic.dlb.report.builder.UserReportAgentBuilder;
 ...
 */
@Controller
@RequestMapping("user_report_agent")
public class UserReportAgentController {
    ...
    @Autowired
    private UserReportAgentBuilder userReportAgentBuilder;
        ...
        if (agentService.isValid(agentSearchCriteriaDto.getAgentCode(),
            ...
            if (authStatus) {
                try {
                    ...
                    response.put("result", userReportAgentBuilder.userReportData(
                            agentService.getUsers(agentSearchCriteriaDto)));
    ...
    public void downloadExcel(HttpSession session, HttpServletResponse resp,
        ...
        if (agentService.isValid(agentCode, systemUser.getDlbWbUserRole().
            ...
            File generateExcel = userReportAgentBuilder.generateExcel(
                    agentService.getUsers(agentSearchCriteriaDto),
